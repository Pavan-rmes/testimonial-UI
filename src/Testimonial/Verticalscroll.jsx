...
function Review({ title, body, author, rating, className, ...props }) {
  ...
  return (
    <figure
      className={clsx(
        'animate-fade-in rounded-3xl bg-white p-6 opacity-1 shadow-md shadow-gray-900/5',
        className
      )}
...
function ReviewColumn({
  ...
  return (
    <div
      // onMouseEnter={()=>{setDuration(`${columnHeight * msPerPixel*10}ms`)}}
      // onMouseLeave={()=>{setDuration(`${columnHeight * msPerPixel}ms`)}}
      ref={columnRef}
      className= {`${clsx('animate-marquee  space-y-8 py-4', className)} scrollstop`}
...
export function Verticalscroll() {
  return (
    <section
      ...
      className="pt-20 pb-16 sm:pt-0 sm:pb-24"
    >
      <Container>
        <ReviewGrid />
      </Container>
